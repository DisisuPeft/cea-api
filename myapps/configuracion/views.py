...
from myapps.configuracion.serializers import MenuItemSerializer
...
class MenuItemview(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not menuItem:
            return Response("Error al obtener el menu, puede que no existan!", status=status.HTTP_404_NOT_FOUND)
